...
import com.rc.aopdemo.domain.ActionType;
import com.rc.aopdemo.domain.ChangeItem;
import com.rc.aopdemo.util.DiffUtil;
import com.rc.aopdemo.util.OptionalUtil;
...
public class DatalogAspect {
    ...
    @Pointcut("execution(public * com.rc.aopdemo.dao.*.save*(..))")
    public void save(){

    }

    @Pointcut("execution(public * com.rc.aopdemo.dao.*.delete*(..))")
    public void delete(){
        ...
        try{
            ...
            if("save".equals(method)){
                ...
                if(id == null){
                    ...
                    //获取Optional内类的真实类型
                    oldObj = OptionalUtil.getGenericType(oldObj);
            ...
            if(ActionType.INSERT == actionType){
                ...
                //获取Optional内类的真实类型
                newObj = OptionalUtil.getGenericType(newObj);
